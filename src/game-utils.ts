...
export class GameUtils {
    ...
    public static createVerticalLine(scene: BABYLON.Scene, position: BABYLON.Vector2) {
        ...
        var myPoints = [new BABYLON.Vector3(position.x, 0, position.y), new BABYLON.Vector3(position.x, 100, position.y)];
        //Create lines
    ...
    public static createMeshFromObjFile(
        ...
        return Observable.create((observer) => {
            BABYLON.SceneLoader.ImportMesh(null, assetsFolder, fileName, scene, (meshes: BABYLON.AbstractMesh[], particleSystems: BABYLON.ParticleSystem[], skeletons: BABYLON.Skeleton[]) => {
                meshes.forEach((mesh) => {
    ...
    public static createShark(scene: BABYLON.Scene): Observable<BABYLON.AbstractMesh> {
        ...
        return GameUtils.createMeshFromObjFile('mesh/', 'mesh.obj', scene, new BABYLON.Vector3(1, 1, 1)).pipe(
            map((meshes) => {
                meshes.forEach((mesh) => {
